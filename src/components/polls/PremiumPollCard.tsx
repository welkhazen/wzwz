            ...
            <div className="mt-auto w-full pt-5">
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className={cn(
                    "relative min-h-[4.8rem] cursor-pointer overflow-hidden px-3 py-3 text-center font-display text-lg tracking-wide transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-raw-gold/70 disabled:cursor-not-allowed",
                    secondarySelected ? "text-black" : "text-[#d9d9d9] hover:text-white",
                ...
                >
                  ...
                  <span className="relative flex flex-col items-center justify-center gap-1">
                    ...
                    {!isAnswered && <span>{secondaryOption.label}</span>}
                  </span>
                </button>
              </div>
            </div>
